...
public class ColaClientes {
    ...
    private GrafoMapa grafo; // Referencia al grafo para auto-crear vértices de ubicación
    ...
    /**
     * Asigna la instancia de GrafoMapa a la cola de clientes.
     */
     ...
     *
     * Además, registra automáticamente la ubicación del cliente como
     * un nuevo vértice en el grafo.
     */
    public void encolar(Cliente cliente) {
        ...
        // Si el grafo está configurado, agrega automáticamente la ubicación del cliente como vértice
        if (this.grafo != null && cliente.getUbicacion() != null && !cliente.getUbicacion().trim().isEmpty()) {
            this.grafo.agregarVertice(cliente.getUbicacion());
        }
